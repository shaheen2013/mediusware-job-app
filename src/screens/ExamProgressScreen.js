...
import {Colors, TouchableOpacity,View,Wizard, Text, RadioGroup, RadioButton, TextField,ThemeManager} from "react-native-ui-lib";
    ...
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <View paddingH-16 flex-12>
                <View>
                    <Wizard activeIndex={activeIndex} onActiveIndexChanged={onActiveIndexChanged} containerStyle={{shadowColor:'none',backgroundColor:'transparent',shadowOffset: {width: 0, height: 0}}}>
